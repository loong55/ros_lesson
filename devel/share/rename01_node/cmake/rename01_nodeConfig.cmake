...
if("TRUE" STREQUAL "TRUE")
  set(rename01_node_SOURCE_PREFIX /home/book/ws/src/rename01_node)
  set(rename01_node_DEVEL_PREFIX /home/book/ws/devel)
  ...
  set(rename01_node_INSTALL_PREFIX /home/book/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rename01_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/book/ws/src/rename01_node/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rename01_node_EXPORTED_TARGETS ${${rename01_node_dep}_EXPORTED_TARGETS})
endforeach()
