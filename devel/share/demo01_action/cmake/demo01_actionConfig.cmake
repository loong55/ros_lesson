...
if("TRUE" STREQUAL "TRUE")
  set(demo01_action_SOURCE_PREFIX /home/book/ws/src/demo01_action)
  set(demo01_action_DEVEL_PREFIX /home/book/ws/devel)
  ...
  set(demo01_action_INSTALL_PREFIX /home/book/ws/install)
...
if(NOT "/home/book/ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'demo01_action' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/book/ws/src/demo01_action/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND demo01_action_EXPORTED_TARGETS ${${demo01_action_dep}_EXPORTED_TARGETS})
endforeach()
