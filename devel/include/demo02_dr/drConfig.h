...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(drConfig::AbstractParamDescriptionConstPtr(new drConfig::ParamDescription<int>("list_param", "int", 0, "列表参数", "{'enum_description': 'a car size set', 'enum': [{'srcline': 27, 'description': 'a small size', 'srcfile': '/home/book/ws/src/demo02_dr/cfg/dr.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'small'}, {'srcline': 28, 'description': 'a medium size', 'srcfile': '/home/book/ws/src/demo02_dr/cfg/dr.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'mediun'}, {'srcline': 29, 'description': 'a big size', 'srcfile': '/home/book/ws/src/demo02_dr/cfg/dr.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'big'}]}", &drConfig::list_param)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 27 "/home/book/ws/src/demo02_dr/cfg/dr.cfg"
      const int dr_small = 0;
//#line 28 "/home/book/ws/src/demo02_dr/cfg/dr.cfg"
      const int dr_mediun = 1;
//#line 29 "/home/book/ws/src/demo02_dr/cfg/dr.cfg"
      const int dr_big = 2;
}
