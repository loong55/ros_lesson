...
class AddintsAction(genpy.Message):
  _md5sum = "f92fb97ab80d70dee1b10e61209fd3a4"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.progerss_bar
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.progerss_bar,) = _get_struct_d().unpack(str[start:end])
      return self
